...
zip -j /root/output/dogecoind-windows-x64.zip /root/output/$HOST/bin/dogecoind.exe /root/output/$HOST/bin/dogecoin-tx.exe /root/output/$HOST/bin/dogecoin-cli.exe /root/output/$HOST/bin/test_dogecoin.exe /root/output/$HOST/bin/test_dogecoin-qt.exe
