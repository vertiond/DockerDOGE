...
zip -j /root/output/dogecoind-aarch64-linux-gnu.zip /root/output/$HOST/bin/dogecoind /root/output/$HOST/bin/dogecoin-tx /root/output/$HOST/bin/dogecoin-cli /root/output/$HOST/bin/test_dogecoin /root/output/$HOST/bin/test_dogecoin-qt
